 ...
 * @date 2021.07.29
 */
public abstract class ConnectionProxyAdapter extends AbstractWrapperProxy implements Connection {

    private DataSourceProxy dataSourceProxy;

    public ConnectionProxyAdapter(Connection connection) {
        super(connection);
    }

    public Connection getConnection() {
        return (Connection) super.getRaw();
    }
